...
public class PlayerGlobal {
    ...
    public static HashMap<Player, ArrayList<Location>> Lyumap_MultiSelect = new HashMap<>();

    public static HashMap<Player, ArrayList<String>> Lyumap_CoolLoc = new HashMap<>();    // 중복 안내 쿨타임 좌표 목록
